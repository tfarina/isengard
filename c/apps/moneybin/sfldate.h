...
short unsigned   pack_date          (long date);
short unsigned   pack_time          (long time);
long   unpack_date        (short unsigned packdate);
long   unpack_time        (short unsigned packtime);
...
int    valid_date         (long date);
int    valid_time         (long time);
int    date_is_future     (long date, long time);
int    date_is_past       (long date, long time);
