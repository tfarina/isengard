...
int main(int argc, char **argv)
{
  ...
  if (argc < 2) {
    fprintf(stderr, "usage: genemasignals <filename>\n");
    return 1;
  }
  ...
  /* Allocate memory for Exponential Moving Average array. */
  ...
  ind_ema(bars->close, bars->numrows, period1, ma1);
  ind_ema(bars->close, bars->numrows, period2, ma2);
