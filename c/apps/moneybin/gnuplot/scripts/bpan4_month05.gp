...
set output 'img/bpan4_month05_candle.png'
...
set terminal png enhanced
set output 'img/bpan4_month05_line.png'

plot 'data/bpan4_month05.dat' using 1:5 notitle with lines lc rgbcolor "black"
